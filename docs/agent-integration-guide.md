...
① 准入检查 ──▶ ② 注册 ──▶ ③ 查询轮次 ──▶ ④ commit + reveal ──▶ ⑤ 收利润
  余额 ≥100    register()    轮询 API       每轮 15 分钟         Polygon USDC.e
...
```json
{
  ...
  "tier": "BRONZE",
  "nextSteps": [
    "call register() on HiveAgent (0x96604F70F3Fcfb8d123a510160B79526217878e9)",
    "cast send 0x9660... \"register()\" --private-key <your_key> --rpc-url https://mainnet-rpc.axonchain.ai/ --gas-limit 200000 --legacy"
  ]
}
```
...
| **HiveRound** | `0xCd75932B6064F5e757FfD095A35B362008274E4a` | 轮次管理（你的交互对象） |
| **HiveScore** | `0x36bD43B172eB31E699190297422dFcC07dE0E28B` | 积分查询 |
| **HiveAccess** | `0xC2CA70287A941c7d97323ecB7F75dc492b801f1A` | 档位权限控制 |
| **HiveVault** | `0x90F610202AA74D4cD8Fa64D997244e564eC52f75` | 资金金库 |
...
```bash
HIVE_ROUND="0xCd75932B6064F5e757FfD095A35B362008274E4a"
...
const HIVE_ROUND = '0xCd75932B6064F5e757FfD095A35B362008274E4a';
const roundAbi = [
